...
describe('MaterialIcon tests', () => {
  it('should be a <i> tag with `zmdi` className', () => {
    expect(
      shallow(<MaterialIcon type='plus' />).is('i.zmdi')
    ).to.equal(true)
  })
  ...
  it('should add the class `zmdi-hc-border-circle` if the `borderCircle` property is present', () => {
    expect(
      shallow(<MaterialIcon type='plus' borderCircle />).is('.zmdi-hc-border-circle')
    ).to.equal(true)
  })
  ...
  it('should add the class `zmdi-hc-spin-reverse` if the `spin` and `reverse` properties are present', () => {
    expect(
      shallow(<MaterialIcon type='plus' spin reverse />).is('.zmdi-hc-spin-reverse')
    ).to.equal(true)
  })
  ...
  it('should add the class `zmdi-hc-flip-horizontal` if the `flip` property is `horizontal`', () => {
    expect(
      shallow(<MaterialIcon type='plus' flip='horizontal' />).is('.zmdi-hc-flip-horizontal')
    ).to.equal(true)
  })

  it('should add the class `zmdi-hc-flip-vertical` if the `flip` property is `vertical`', () => {
    expect(
      shallow(<MaterialIcon type='plus' flip='vertical' />).is('.zmdi-hc-flip-vertical')
    ).to.equal(true)
  })
  ...
  it('should not add the class `zmdi-hc-flip-{axis}` if the `flip` value is other than `horizontal` or `vertical`', () => {
    ...
    expect(
      shallow(icon).is('.zmdi-hc-flip-horizontal')
    ).to.equal(false)

    expect(
      shallow(icon).is('.zmdi-hc-flip-vertical')
    ).to.equal(false)
  })
  ...
  it('should add the class `zmdi-hc-rotate-{degrees}` if the `rotate` property is one of the valid rotation values', () => {
    ...
    expect(
      shallow(<MaterialIcon type='plus' rotate={ 180 } />).is('.zmdi-hc-rotate-180')
    ).to.equal(true)

    expect(
      shallow(<MaterialIcon type='plus' rotate={ 270 } />).is('.zmdi-hc-rotate-270')
    ).to.equal(true)
  })
  ...
  it('should not add the class `zmdi-hc-rotate-{degrees}` if the `degrees` value is other than `90`, `180` or `270`', () => {
    ...
    expect(
      shallow(icon).is('.zmdi-hc-rotate-60')
    ).to.equal(false)
  })
})
